    ...
    return (
        <AppBar position="fixed" sx={{backgroundColor: scroll > 0 ? { xl:"#ffffff",lg:"#ffffff",sm:"#ffffff", md:"#ffffff",xs:"#ffffff" } :  { xl:'transparent', lg:"#ffffff", sm:"#ffffff", md:"#ffffff",xs:"#ffffff" },boxShadow: scroll > 0 ? "0px 2px 0px 0px rgba(0, 0, 0, 0.2)" : "none",
            ...
            <Toolbar disableGutters>
                    ...
                    >
                        <Grid item xs={2} sm={6} md={6} lg={6} xl={6} alignContent="screenLeft">
                            <img src={logo}
                                 style={{
                                     height: 100,
                                     marginRight: '1em',
                        ...
                        <Grid className={"123"} item xs={2} sm={6} md={6} lg={6} xl={6} style={{alignItems:"center",justifyContent:"center"}} sx={{top:"50%",left:"50%"}}>
                            <Stack spacing={2} direction="row" justifyContent={"flex-end"} sx={{padding:5}}>
                                <Button variant="contained" onClick={() => signIn()}><Typography style={{fontWeight:"bold"}}>Sign in</Typography></Button>
