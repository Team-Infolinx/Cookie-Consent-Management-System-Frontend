...
const homeCards = [
  {
    title: "Scan Cookies",
    content: "Deep scan your website for cookies using our extensive database.",
  },
  {
    title: "Customizable Banner",
    content:
      "Customize the banner layout, colour, content, behaviour, branding and add CSS customization to match your website’s design.",
  },
  {
    title: "Consent Log",
    content:
  ...
  },
  {
    title: "Analytics",
    content:
      "Get insights into your website's cookie usage with our analytics tool.",
  },
];
const Features = () => {
  return (
