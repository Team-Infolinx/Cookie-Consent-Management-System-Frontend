        ...
        <div>
            ...
            <List>
                <ListItem disablePadding>
                    <ListItemButton
                        selected={location.pathname === drawerItemsBottom[0].link}
                    >
                        <ListItemIcon>{drawerItemsBottom[0].icon}</ListItemIcon>
                        <ListItemText primary={drawerItemsBottom[0].item} />
                    </ListItemButton>
                </ListItem>
                <ListItem disablePadding>
                    <ListItemButton onClick={() => signOut()}>
                        <ListItemIcon>{drawerItemsBottom[1].icon}</ListItemIcon>
                        <ListItemText primary={drawerItemsBottom[1].item} />
                    </ListItemButton>
                </ListItem>
            </List>
        </div>
